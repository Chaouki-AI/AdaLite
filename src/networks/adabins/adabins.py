...
class mViT(nn.Module):
    def __init__(self, in_channels, n_query_channels=128, patch_size=16, dim_out=256,
                 embedding_dim=128, num_heads=4, norm='softmax'):
...
class DecoderBN(nn.Module):
    ...
    def forward(self, features):
        ...
        self.features = [x_d0, x_d1, x_d2, x_d3, x_d4]
...
class Encoder(nn.Module):
    ...
    def forward(self, x):
        ...
        self.features = [features[4], features[5], features[6], features[8], features[11]]
        return features


class UnetAdaptiveBins(nn.Module):
    def __init__(self, backend, args, n_bins):
    ...
    def forward(self, x, **kwargs):
        unet_out, feats = self.decoder(self.encoder(x), **kwargs)
        self.features = feats
        ...
        self.features = [range_attention_maps, out]
        #print(out.shape)
    ...
    @classmethod
    def build(cls, args, n_bins, **kwargs):
        ...
        m = cls(basemodel, args = args, n_bins=n_bins, **kwargs)
        print('Done.')
        return m
