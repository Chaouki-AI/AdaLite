...
echo "Creating the conda environment 'AdaLite' with Python 3.9..."

# Create the environment
conda create -n AdaLite python=3.9 -y

# Activate the environment
source activate AdaLite
...
echo "Installing timm, openmim, and easydict..."
pip install timm
...
echo "Environment setup complete! You can now activate the environment using 'conda activate AdaLite'."
